...
fn test_class_id_emitted_on_every_ship_snapshot() {
    ...
    assert_ne!(
        by_class_id["basic_heavy_cruiser"].0, by_class_id["tutorial_heavy_cruiser"].0,
        "basic_heavy_cruiser and tutorial_heavy_cruiser are distinct ships"
    );
    assert_ne!(
        by_class_id["basic_swarm"].0, by_class_id["tutorial_escort"].0,
        "basic_swarm and tutorial_escort are distinct ships"
    );
