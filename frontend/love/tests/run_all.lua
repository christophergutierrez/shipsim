...
assert_eq(#yd.weapons, 2, "default weapon count")
assert_eq(yd.weapons[1].component, "beam", "default weapon one sku")
assert_eq(yd.weapons[1].mount, "forward", "default weapon one mount")
assert_eq(yd.weapons[2].component, "torpedo", "default weapon two sku")
assert_eq(yd.weapons[2].mount, "forward", "default weapon two mount")
yd.engine = "fusion"
yd.engine_size = "l"
...
assert_eq(parsed.weapons[1].mount, "forward", "round-trip weapon one mount")
assert_eq(parsed.weapons[2].component, "torpedo", "round-trip weapon two sku")
assert_eq(parsed.weapons[2].mount, "forward", "round-trip weapon two mount")
